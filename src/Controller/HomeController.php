...
class HomeController extends AbstractController
{
     ...
     * Aquí centralizo el filtro y la paginación, siguiendo el patrón MVC y manteniendo la responsabilidad de HomeController solo en el listado.
     */
    #[Route('/', name: 'home')]
    public function index(BienRepository $bienRepository, Request $request, PaginatorInterface $paginator): Response
    {
        ...
        $bienes = $paginator->paginate( $qb, $page, 9                             // Número de elementos por página
);
