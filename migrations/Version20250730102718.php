 ...
 */
final class Version20250730102718 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bien (id_bien INT AUTO_INCREMENT NOT NULL, id_proprietaire INT DEFAULT NULL, type_de_bien VARCHAR(50) DEFAULT NULL, ville VARCHAR(100) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, prix NUMERIC(15, 2) DEFAULT NULL, surface_m2 INT DEFAULT NULL, etat_du_bien VARCHAR(255) DEFAULT NULL, foto VARCHAR(255) DEFAULT NULL, tipo_transaccion VARCHAR(30) DEFAULT NULL, INDEX IDX_45EDC3864A22ECA4 (id_proprietaire), PRIMARY KEY(id_bien)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
